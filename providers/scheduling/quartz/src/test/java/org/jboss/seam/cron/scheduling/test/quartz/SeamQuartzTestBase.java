 ...
 * @author Peter Royle
 */
public abstract class SeamQuartzTestBase extends SeamSchedulingTestBase {

    private static Logger log = Logger.getLogger(SeamQuartzTestBase.class);

    public static JavaArchive createDefaultArchive() 
    {
    	JavaArchive archive = SeamSchedulingTestBase.createDefaultArchive()
